...
SECRET_KEY = 'django-insecure-ar+ixm#u&16(cl-!0%q^w@n3!2$&7_$%_ls@e5fypwb88=#pe+'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'defaultdb',
        'USER': 'avnadmin',
        'PASSWORD': 'AVNS_MuxKQk6PIANZyukLg1r',  # Environment variable
        # 'PASSWORD': os.environ.get('DB_PASSWORD', 'default_password'),  # Environment variable
        'HOST': 'mysql-324749f0-event-platform.d.aivencloud.com',
        'PORT': '12410',
    }
}
...
EMAIL_HOST_USER='adheeshzkp@gmail.com'
EMAIL_HOST_PASSWORD='ryyx ggpa fywn mchz'
EMAIL_PORT=587
